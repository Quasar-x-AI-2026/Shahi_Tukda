      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          ...
          <div className="relative">
            <User className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors duration-200 ${focusedField === "name" ? "text-accent" : "text-muted-foreground"
              }`} />
            <Input
              type="text"
              ...
              className={`pl-12 h-12 bg-card/50 border-border/50 rounded-xl transition-all duration-200 ${focusedField === "name"
        ...
        >
          ...
          <div className="relative">
            <Mail className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors duration-200 ${focusedField === "email" ? "text-accent" : "text-muted-foreground"
              }`} />
            <Input
              type="email"
              ...
              onBlur={() => setFocusedField(null)}
              className={`pl-12 h-12 bg-card/50 border-border/50 rounded-xl transition-all duration-200 ${focusedField === "email"
                ? "border-accent ring-2 ring-accent/20"
                : "hover:border-border"
                }`}
              required
        ...
        >
          ...
          <div className="relative">
            <Phone className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors duration-200 ${focusedField === "mobile" ? "text-accent" : "text-muted-foreground"
              }`} />
            <Input
              type="tel"
              ...
              onBlur={() => setFocusedField(null)}
              className={`pl-12 h-12 bg-card/50 border-border/50 rounded-xl transition-all duration-200 ${focusedField === "mobile"
                ? "border-accent ring-2 ring-accent/20"
                : "hover:border-border"
                }`}
              required
        ...
        >
          ...
          <div className="relative">
            <Lock className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors duration-200 ${focusedField === "password" ? "text-accent" : "text-muted-foreground"
              }`} />
            <Input
              ...
              onBlur={() => setFocusedField(null)}
              className={`pl-12 pr-12 h-12 bg-card/50 border-border/50 rounded-xl transition-all duration-200 ${focusedField === "password"
                ? "border-accent ring-2 ring-accent/20"
                : "hover:border-border"
                }`}
              required
              ...
              <div className="flex items-center gap-2 mb-1">
                <div className="flex-1 h-1.5 bg-muted rounded-full overflow-hidden flex gap-1">
                  {[1, 2, 3, 4, 5].map((level) => (
                    <motion.div
                      key={level}
                      className={`flex-1 rounded-full ${level <= passwordStrength.score
                ...
                <span className={`text-xs font-medium ${passwordStrength.score <= 2 ? "text-risk-high" :
